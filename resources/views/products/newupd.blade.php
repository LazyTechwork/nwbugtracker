        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('products.newupd', ['id'=>$prod->id]) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="prodname">Версия</label>
                        <input type="text" name="version" class="form-control" id="prodname"
                    ...
                    <div class="form-group">
                        <label for="prodname">Московское время выпуска обновления <span class="text-muted">(дата и время должны быть не меньше текущего и не больше одного дня позже, для безопасности на клиентской стороне мы ограничили ввод)</span></label>
                        <input type="datetime-local" name="time" class="form-control" id="prodname"
